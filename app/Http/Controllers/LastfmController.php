...
class LastfmController extends Controller
{
    ...
    public function connect()
    {
        abort_unless(
            ...
            'AudioStreaming is not configured to use with Last.fm yet.'
        );
        ...
        $url = sprintf('https://www.last.fm/api/auth/?api_key=%s&cb=%s', config('AudioStreaming.lastfm.key'), $callbackUrl);
