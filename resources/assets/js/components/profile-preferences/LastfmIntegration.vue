<template>
  <section class="text-secondary">
    ...
    <div v-if="useLastfm" data-testid="lastfm-integrated">
      <p>Last.fm integration is enabled. AudioStreaming will attempt to retrieve album and artist information from Last.fm.</p>
      <p v-if="connected">
      ...
      <p>
        Connecting AudioStreaming and your Last.fm account enables such exciting features as
        <a
    ...
    <div v-else data-testid="lastfm-not-integrated">
      <p>
        Last.fm integration is not enabled on this installation of AudioStreaming.
        <span v-if="isAdmin" data-testid="lastfm-admin-instruction">
          Visit
          <a href="https://docs.AudioStreaming.dev/3rd-party.html#last-fm" class="text-highlight" target="_blank">AudioStreaming’s Wiki</a>
          for a quick how-to.
        </span>
 ...
 * AudioStreaming will reload once the connection is successful.
 */
