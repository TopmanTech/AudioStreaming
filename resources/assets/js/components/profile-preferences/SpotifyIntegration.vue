  ...
  <section class="text-secondary">
    ...
    <div v-if="useSpotify">
      <p>
        ...
        AudioStreaming will attempt to retrieve album arts and artist images from Spotify when a song is played, if needed.
      </p>
    </div>
    <div v-else>
      <p>
        ...
        <span v-if="isAdmin" data-testid="spotify-admin-instruction">
          Visit
          <a href="https://docs.AudioStreaming.dev/3rd-party.html#spotify" class="text-highlight" target="_blank">AudioStreaming’s Wiki</a>
          for a quick how-to.
        </span>
