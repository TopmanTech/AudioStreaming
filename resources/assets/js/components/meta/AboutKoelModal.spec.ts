...
import AboutAudioStreamingModel from './AboutAudioStreamingModal.vue'

new class extends UnitTestCase {
  private renderComponent () {
    return this.render(AboutAudioStreamingModel, {
      global: {
        stubs: {
  ...
  protected test () {
    ...
    it('shows demo notation', async () => {
      ...
      // @ts-ignore
      import.meta.env.VITE_AudioStreaming_ENV = 'demo'
