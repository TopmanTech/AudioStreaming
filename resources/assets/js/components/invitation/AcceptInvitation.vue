<template>
  <div class="invitation-wrapper">
    <form v-if="userProspect" autocomplete="off" @submit.prevent="submit">
      <header>
        Welcome to AudioStreaming! To accept the invitation, fill in the form below and click that button.
      </header>
      ...
      <div class="form-row">
        <label>
          Your name
          <input v-model="formData.name" v-AudioStreaming-focus type="text" required placeholder="Erm… Bruce Dickinson?">
        </label>
      </div>
