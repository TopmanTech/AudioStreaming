  ...
  <div ref="el" class="song-list-controls" data-testid="song-list-controls">
    <div class="wrapper">
      ...
      <BtnGroup v-if="config.refresh || config.deletePlaylist">
        <Btn v-if="config.refresh" v-AudioStreaming-tooltip green title="Refresh" @click.prevent="refresh">
          <Icon :icon="faRotateRight" fixed-width />
        </Btn>

        <Btn
          v-if="config.deletePlaylist"
          v-AudioStreaming-tooltip
    ...
    <div ref="addToMenu" v-AudioStreaming-clickaway="closeAddToMenu" class="menu-wrapper">
