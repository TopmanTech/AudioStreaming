...
const modalNameToComponentMap = {
  ...
  'about-AudioStreaming': defineAsyncComponent(() => import('@/components/meta/AboutAudioStreamingModal.vue')),
...
eventBus.on('MODAL_SHOW_ABOUT_AudioStreaming', () => (activeModalName.value = 'about-AudioStreaming'))
