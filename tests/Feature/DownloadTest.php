...
class DownloadTest extends TestCase
{
    ...
    public function testDownloadOneSong(): void
    {
        ...
        $this->get("download/songs?songs[]={$song->id}&api_token=" . $user->createToken('AudioStreaming')->plainTextToken)
            ->assertOk();
    }
    ...
    public function testDownloadMultipleSongs(): void
    {
        ...
        $this->get(
            ...
            . $user->createToken('AudioStreaming')->plainTextToken
        )
            ->assertOk();
    }
    ...
    public function testDownloadAlbum(): void
    {
        ...
        $this->get("download/album/{$album->id}?api_token=" . $user->createToken('AudioStreaming')->plainTextToken)
            ->assertOk();
    }
    ...
    public function testDownloadArtist(): void
    {
        ...
        $this->get("download/artist/{$artist->id}?api_token=" . $user->createToken('AudioStreaming')->plainTextToken)
            ->assertOk();
    }
    ...
    public function testDownloadPlaylist(): void
    {
        ...
        $this->get("download/playlist/{$playlist->id}?api_token=" . $user->createToken('AudioStreaming')->plainTextToken)
            ->assertOk();
    }
    ...
    public function testDownloadFavorites(): void
    {
        ...
        $this->get('download/favorites?api_token=' . $user->createToken('AudioStreaming')->plainTextToken)
            ->assertOk();
    }
}
