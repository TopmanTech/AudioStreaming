...
class AlbumInformationTest extends TestCase
{
    ...
    {
        config(['AudioStreaming.lastfm.key' => 'foo']);
        config(['AudioStreaming.lastfm.secret' => 'geheim']);
    ...
    {
        config(['AudioStreaming.lastfm.key' => null]);
        config(['AudioStreaming.lastfm.secret' => null]);
