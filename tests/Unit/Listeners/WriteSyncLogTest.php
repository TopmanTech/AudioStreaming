...
class WriteSyncLogTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->originalLogLevel = config('AudioStreaming.sync_log_level');
    ...
    protected function tearDown(): void
    {
        ...
        config(['AudioStreaming.sync_log_level' => $this->originalLogLevel]);
    ...
    {
        config(['AudioStreaming.sync_log_level' => 'all']);
    ...
    {
        config(['AudioStreaming.sync_log_level' => 'error']);
