...
class UploadServiceTest extends TestCase
{
    ...
    {
        Setting::set('media_path', '/media/AudioStreaming');
        ...
        $file->shouldReceive('move')
            ->once()
            ->with('/media/AudioStreaming/__AudioStreaming_UPLOADS__/', 'foo.mp3');
        ...
        $this->fileSynchronizer
            ...
            ->once()
            ->with()
            ->andReturn(SyncResult::error('/media/AudioStreaming/__AudioStreaming_UPLOADS__/foo.mp3', 'A monkey ate your file oh no'));
    ...
    public function testHandleUploadedFile(): void
    {
        ...
        $this->fileSynchronizer
            ->shouldReceive('sync')
            ->once()
            ->andReturn(SyncResult::success('/media/AudioStreaming/__AudioStreaming_UPLOADS__/foo.mp3'));
