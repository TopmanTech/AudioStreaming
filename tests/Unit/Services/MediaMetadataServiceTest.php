...
class MediaMetadataServiceTest extends TestCase
{
    ...
    public function testWriteAlbumCover(): void
    {
        ...
        $coverPath = '/AudioStreaming/public/img/album/foo.jpg';

        $this->imageWriter
            ->shouldReceive('write')
            ->once()
            ->with('/AudioStreaming/public/img/album/foo.jpg', 'dummy-src');
    ...
    public function testWriteArtistImage(): void
    {
        ...
        $imagePath = '/AudioStreaming/public/img/artist/foo.jpg';

        $this->imageWriter
            ->shouldReceive('write')
            ->once()
            ->with('/AudioStreaming/public/img/artist/foo.jpg', 'dummy-src');
