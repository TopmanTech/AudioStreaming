...
class SpotifyServiceTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        config([
            'AudioStreaming.spotify.client_id' => 'fake-client-id',
            'AudioStreaming.spotify.client_secret' => 'fake-client-secret',
        ]);
    ...
    {
        config(['AudioStreaming.spotify.client_id' => null]);
    ...
    {
        config([
            'AudioStreaming.spotify.client_id' => null,
            'AudioStreaming.spotify.client_secret' => null,
        ]);
